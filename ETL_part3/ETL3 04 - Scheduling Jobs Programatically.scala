...
val token = "1234"
val domain = "https://example.cloud.databricks.com/api/2.0/"
...
val path = dbutils.notebook.run("./Runnable/Runnable-4", 120, Map("username" -> getUsername(), "ranBy" -> "NOTEBOOK"))
...
if (APICounts > 0)
  ...
  println("Test failed, no records found")
