...
withColumn("ssnNums", regexp_replace(col("ssn"), "-", ""))
...
// TODO
val dedupedDF = dupedWithColsDF.dropDuplicates(Array("lcFirstName", "lcMiddleName", "lcLastName", "ssnNums", "gender", "birthDate", "salary")).drop("lcFirstName", "lcMiddleName", "lcLastName", "ssnNums")
