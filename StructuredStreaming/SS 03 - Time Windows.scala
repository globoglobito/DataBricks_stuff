...
// MAGIC     var allHints = document.getElementsByClassName("hint-6132");
// MAGIC     var answer = document.getElementById("answer-6132");
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-6132");
...
// MAGIC           id="hint-button-6132">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-6132" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-5996");
// MAGIC     var answer = document.getElementById("answer-5996");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-5996");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-5996">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-5996" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-7602");
// MAGIC     var answer = document.getElementById("answer-7602");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-7602");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-7602">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-7602" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-2126");
// MAGIC     var answer = document.getElementById("answer-2126");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-2126");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-2126">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-2126" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
...
// MAGIC <script type="text/javascript">
// MAGIC   window.onload = function() {
// MAGIC     var allHints = document.getElementsByClassName("hint-5025");
// MAGIC     var answer = document.getElementById("answer-5025");
// MAGIC     var totalHints = allHints.length;
// MAGIC     var nextHint = 0;
// MAGIC     var hasAnswer = (answer != null);
// MAGIC     var items = new Array();
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-5025");
// MAGIC     if (totalHints == 0) {
// MAGIC       button.innerHTML = answerLabel;
// MAGIC     }
// MAGIC     button.onclick = function() {
...
// MAGIC   <button type="button" class="btn btn-light"
// MAGIC           style="margin-top: 1em"
// MAGIC           id="hint-button-5025">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-5025" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
// MAGIC   <div class="answer" style="margin-left: 1em">
