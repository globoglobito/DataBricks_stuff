...
// MAGIC     var allHints = document.getElementsByClassName("hint-872");
// MAGIC     var answer = document.getElementById("answer-872");
...
// MAGIC     }
// MAGIC 
// MAGIC     var button = document.getElementById("hint-button-872");
...
// MAGIC           id="hint-button-872">Click here for a hint</button>
// MAGIC </div>
// MAGIC <div id="answer-872" style="padding-bottom: 20px; display: none">
// MAGIC   The answer:
...
try {
  ...
  streamingQuery.awaitTermination(10*1000) 
